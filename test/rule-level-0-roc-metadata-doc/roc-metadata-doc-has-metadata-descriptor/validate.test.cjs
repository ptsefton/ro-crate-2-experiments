// Test for roc-metadata-doc-has-metadata-descriptor rule
const fs = require('fs');
const path = require('path');
const { Roc2Validator } = require('../../../scripts/ro-crate-metadata-doc-validator.cjs');

describe('roc-metadata-doc-has-metadata-descriptor', () => {
  ...
  it('should pass for all good files', () => {
    ...
    for (const file of files) {
      ...
      const result = validator.rocMetadataDocHasMetadataDescriptor(content);
      if (!result.pass) {
